        ...
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 mt-16">
          <div className="mx-auto grid max-w-2xl grid-cols-1 grid-rows-1 items-start gap-x-8 gap-y-8 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            ...
            <div className="lg:col-start-3 lg:row-end-1">
              <div className="rounded-lg bg-gray-50 shadow-sm ring-1 ring-gray-900/5">
                <dl className="flex flex-col flex-wrap">
                  ...
                  <div className="flex-auto pl-6 pt-6">
                    <dt className="text-sm font-semibold leading-6 text-gray-900">Net Social Value</dt>
                    <dd className="mt-1 text-base font-semibold leading-6 text-gray-900">30,560.00 €</dd>
                  </div>
                  <div className="flex-auto pl-6 pt-6">
                    <dt className="text-sm font-semibold leading-6 text-gray-900">SROI</dt>
                    <dd className="mt-1 text-base font-semibold leading-6 text-gray-900">3.25</dd>
                  </div>
                  ...
                  <div className="mt-6 flex w-full flex-none gap-x-4 border-t border-gray-900/5 px-6 pt-6">
                    ...
                    <dd className="text-sm font-medium leading-6 text-gray-900">Nome Utente</dd>
                  </div>
                ...
                <div className="mt-6 border-t border-gray-900/5 px-6 py-6">
                  <a href="#" className="text-sm font-semibold leading-6 text-gray-900">
                    Sarica scheda progetto <span aria-hidden="true">&darr;</span>
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="-mx-4 px-4 py-8 shadow-sm ring-none ring-gray-900/5 sm:mx-0 sm:rounded-lg sm:px-8 sm:pb-14 lg:col-span-2 lg:row-span-2 lg:row-end-2 xl:px-16 xl:pb-20 xl:pt-16">
              <h2 className="text-2xl font-semibold leading-6 text-gray-900">Nome del progetto <span className="rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-600 ring-1 ring-inset ring-green-600/20">
                      Avviato
                    </span></h2>
              <dl className="mt-6 grid grid-cols-1 text-sm leading-6 sm:grid-cols-2">
                
                <div className="mt-6 border-t border-gray-900/5 pt-6 sm:pr-4">
                  <dt className="font-semibold text-gray-900">Operatore responsabile del progetto</dt>
                  <dd className="mt-2 text-gray-500">
                    <span className="font-medium text-gray-900">Nome Associazione</span>
                    <br />
                    via dei mille, 5
                    <br />
                    Roma, Italia
